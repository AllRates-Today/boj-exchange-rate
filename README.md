...
Official **Bank of Japan** (Japan) daily exchange rates in Node.js / TypeScript — 1 currencies against the JPY, with history back to 1998. Zero dependencies, works in Node 18+, Bun, Deno, and edge runtimes (uses global `fetch`).
...
Powered by [AllRatesToday](https://allratestoday.com/central-bank-rates-api/boj/). Get a free API key at [allratestoday.com/register](https://allratestoday.com/register) — no credit card required.
